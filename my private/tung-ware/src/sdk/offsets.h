...
namespace Offsets {
    ...
    namespace Animator {
          inline Offset ActiveAnimations = { "Animator::ActiveAnimations", 0x888 };
    }
    ...
    namespace Clothing {
          inline Offset Color3 = { "Clothing::Color3", 0x138 };
          inline Offset Template = { "Clothing::Template", 0x118 };
    }
    ...
    namespace DataModel {
          inline Offset CreatorId = { "DataModel::CreatorId", 0x198 };
          inline Offset GameId = { "DataModel::GameId", 0x1a0 };
          inline Offset GameLoaded = { "DataModel::GameLoaded", 0x678 };
          inline Offset JobId = { "DataModel::JobId", 0x138 };
          inline Offset PlaceId = { "DataModel::PlaceId", 0x1a8 };
          inline Offset PlaceVersion = { "DataModel::PlaceVersion", 0x1c4 };
          inline Offset PrimitiveCount = { "DataModel::PrimitiveCount", 0x4a8 };
          inline Offset ScriptContext = { "DataModel::ScriptContext", 0x440 };
          inline Offset ServerIP = { "DataModel::ServerIP", 0x660 };
          inline Offset ToRenderView1 = { "DataModel::ToRenderView1", 0x1e0 };
    ...
    namespace FakeDataModel {
          inline Offset Pointer = { "FakeDataModel::Pointer", 0x7bcf6a8 };
    ...
    namespace Instance {
          ...
          inline Offset ClassBase = { "Instance::ClassBase", 0xcc0 };
    ...
    namespace Player {
          ...
          inline Offset CameraMode = { "Player::CameraMode", 0x35c };
          inline Offset DisplayName = { "Player::DisplayName", 0x150 };
          inline Offset HealthDisplayDistance = { "Player::HealthDisplayDistance", 0x37c };
          inline Offset LocalPlayer = { "Player::LocalPlayer", 0x148 };
          inline Offset LocaleId = { "Player::LocaleId", 0x130 };
          inline Offset MaxZoomDistance = { "Player::MaxZoomDistance", 0x354 };
          inline Offset MinZoomDistance = { "Player::MinZoomDistance", 0x358 };
          inline Offset ModelInstance = { "Player::ModelInstance", 0x3d0 };
          inline Offset Mouse = { "Player::Mouse", 0x1188 };
          inline Offset NameDisplayDistance = { "Player::NameDisplayDistance", 0x38c };
          inline Offset Team = { "Player::Team", 0x2d0 };
          inline Offset TeamColor = { "Player::TeamColor", 0x398 };
    ...
    namespace TaskScheduler {
          ...
          inline Offset Pointer = { "TaskScheduler::Pointer", 0x815c668 };
    }
    namespace Team {
    ...
    namespace Tool {
          inline Offset CanBeDropped = { "Tool::CanBeDropped", 0x4c0 };
          inline Offset Enabled = { "Tool::Enabled", 0x4c1 };
          inline Offset Grip = { "Tool::Grip", 0x4b4 };
          inline Offset ManualActivationOnly = { "Tool::ManualActivationOnly", 0x4c2 };
          inline Offset RequiresHandle = { "Tool::RequiresHandle", 0x4c3 };
          inline Offset TextureId = { "Tool::TextureId", 0x368 };
          inline Offset Tooltip = { "Tool::Tooltip", 0x470 };
    }
    ...
    namespace VisualEngine {
          ...
          inline Offset Pointer = { "VisualEngine::Pointer", 0x82ea3f8 };
    ...
    namespace Workspace {
          ...
          inline Offset ReadOnlyGravity = { "Workspace::ReadOnlyGravity", 0x9e8 };
